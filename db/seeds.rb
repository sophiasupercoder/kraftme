...
products = [
    ...
    {
        product_title: 'Shredded',
        description: 'measurement:big',
        price: 20000,
        medium: 'paper',
        quantity: 1,
        creator: 'Doctor',
    ...
    {
        product_title: 'Shearing!',
        description: 'It\'s BIG! and goes on the wall. people are in it.',
        price: 400,
        medium: 'oil paint',
        quantity: 7,
        creator: 'Aussie',
    ...
    },
    {
        ...
        medium: 'oil paint',
        quantity: 1,
        creator: 'Leonardo Decaprio',
        user: User.find(2),
    },
    {
        product_title: 'A tiger',
    ...
    {
        product_title: 'A summers day',
        description: 'it is big and goes on a wall',
        price: 400,
        medium: 'oil paint',
        quantity: 104,
        creator: 'GOD',
    ...
    {
        product_title: 'Nighty, Starry!',
        description: 'A perfect work of art',
        price: 40000,
        medium: 'oil paint',
        quantity: 7,
        creator: 'Ganiv hen voncug',
        user: User.find(2),
    },
]
